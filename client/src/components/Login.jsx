...
class Login extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      password: "",
      array: [],
      boli: false,// __variable should have meaningful names
      oboli: false,
    };
  ...
  sign() {
    ...
    this.setState({ boli: bol }); // __no request send
  }
  hashCode(str) {
    var hash = 0;
    if (str.length == 0) {
          ...
          <div>
            {!this.state.oboli ? (
              <div>
                ...
                <br />
                <input type="name" onChange={this.takeName.bind(this)} />
                <br />
                <label />Enter password<br />
                {/* __type is password not new-password  */}
                <input
                  type="new-password"
                  onChange={this.takePassword.bind(this)}
                />
                <br />
                <button onClick={this.check.bind(this)}>login</button>
                <p>
                  if you dont have an acount <a onClick={this.sign}>sign up</a>
                </p>
              </div>
            ) : (
              <NewNav />
...
export default Login;// __login should only take care of login page
